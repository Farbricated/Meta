...
class MetaEnv(
    EnvClient[MetaAction, MetaObservation, State]
):
    """
    ...
    Example:
        ...
        >>> with MetaEnv(base_url="http://localhost:8000") as client:
        ...     result = client.reset()
        ...     print(result.observation.echoed_message)
        ...
        ...     result = client.step(MetaAction(message="Hello!"))
        ...     print(result.observation.echoed_message)

    Example with Docker:
        >>> # Automatically start container and connect
        >>> client = MetaEnv.from_docker_image("Meta-env:latest")
        >>> try:
        ...     result = client.reset()
        ...     result = client.step(MetaAction(message="Test"))
        ... finally:
        ...     client.close()
    """
    ...
    def _parse_result(self, payload: Dict) -> StepResult[MetaObservation]:
        ...
        Returns:
            StepResult with MetaObservation
        """
